...
input_workspace <- as.character(commandArgs(TRUE)[1]) #TO UPDATE
output_workspace <- as.character(commandArgs(TRUE)[2]) #TO UPDATE
...
nb_cores <- as.numeric(commandArgs(TRUE)[3]) #TO UPDATE
min_cov <- as.numeric(commandArgs(TRUE)[4]) #TO UPDATE
min_vaf <- as.numeric(commandArgs(TRUE)[5]) #TO UPDATE
